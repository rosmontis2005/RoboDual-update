...
# = [8 GPU] Fast Iteration =>> DINO-SigLIP 224px + Stanford =
@dataclass
class Exp_DinoSigLIP_224px_Stanford(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-stanford"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"

    data_mix: str = "stanford"
...
class VLARegistry(Enum):
    ...
    DINOSIGLIP_224PX_MX_STANFORD = Exp_DinoSigLIP_224px_Stanford
